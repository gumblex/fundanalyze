...
def infnone(x): return float('-inf') if x is None else x
...
# ---------------------------------------------------------------
    ...
    def initAlgo(self):
        ...
        b = [self.mean[i][0]
             for i in range(self.mean.shape[0])]  # dump array into list
